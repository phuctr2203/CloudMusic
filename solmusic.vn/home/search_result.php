                        ...
                        <div class="col-lg-12">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label class="control-label">Search for Artist</label>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    if (isset($_POST["submit"])) {
                                                        $name = $_POST["search"];
                                                        $sub_list = [];
                                                        $list = get_store_search_name($name);
                                                        if($list == false) {
                                                            print_r("<div class='grid'><h2>Sorry we currently don't have any artist</h2></div>");
                                                        } else {
                                                            $sub_list = $list;
                                                            $count = 1;

                                                            foreach($sub_list as $artist)
                                                            {
                                                                echo "<tr>";
                                                                    echo "<td>$count</td>";
                                                                    echo "<td>";
                                                                    ...
                                                                    echo "</td>";
                                                                    echo "<td>$artist[0]</td>";
                                                                    echo "<td class='text-center'>$artist[1]</td>";
                                                                    echo "<td class='text-center'>$artist[2]</td>";

                                                                    echo "<td class='text-center'>";
                                                                    echo "<a class='btn btn-xs btn-default' href='my_playlist.php?song_name=$artist[0]&artist_name=$artist[1]&album_name=$artist[2]' title='Edit Playlist'>";
