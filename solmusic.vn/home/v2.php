    ...
    <div class="container">
      <div class="row">
        <div class="col-xs-12 col-md-6">
          ...
          <div class="voffset20"></div>
          <p class="cousine subtitulo">SolMusic is a solution to use copyrighted music with a high-quality, always-updated music store for business models such as Retail & Supermarkets, Restaurant Chains, Cafe Chains, Bars & Pubs, Spas & Gyms , Workspaces, as well as for other personal uses.</p>
          <div class="voffset30"></div>
          
            <div class="row">
              <div class="col-xs-12 col-sm-4">
                <input class="btn square stay-in-touch-submit createpl" type="submit" name="button" value="Explore SolMusic's Playlist">
              </div>
            </div>
...
<section class="section container-fluid full-width biography" id="anchor04">
  <div class="row">
    <div class="col-xs-12 col-md-4 col-md-offset-1 biography-description">
      ...
      <p class="cousine">SolMusic's management tool allows you to create playlists, select music genres, and moods. Allows scheduling, arranging music playback time & advertising uniformly or separately between branches, thereby helping to increase brand awareness. Centralized management system, user-friendly interface, simple operation, offline music playback even without internet.</p>
      <div class="voffset40"></div>
      <div class="row">
        <div class="col-xs-12 col-sm-4">
          <input class="btn square stay-in-touch-submit createpl" type="submit" name="button" value="Explore SolMusic's Playlist">
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-8 col-md-offset-2">
        <div class="voffset70"></div>
        <div class="title-wrapper">
          <h2 class="title">WHY YOU SHOULD USE SOLMUSIC</h2>
        </div>
        <div class="voffset80"></div>
      </div>
    </div>
