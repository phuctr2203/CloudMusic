                                ...
                                <div class="panel panel-bd">
                                    ...
                                    <div class="panel-body">
                                        <div class="form-group row">
                                            <span for="example-url-input" class="col-sm-2 col-form-label">Họ Tên<span class="start-red">*</span></span>
                                            <div class="col-sm-4">
                                            ...
                                            <span for="example-url-input" class="col-sm-2 col-form-label" required="">Nghệ danh<span class="start-red">*</span></span>
                                            <div class="col-sm-4">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-1">
                                                <div class="i-check">
                                                    ...
                                                    <label for="rd-radio-singer" style="font-weight:0px!important;">Ca sĩ</label>
                                                </div>
                                            </div>
                                            <div class="col-sm-2">
                                                <div class="i-check">
                                                    <input tabindex="7" type="radio" id="rd-radio-artist" name="type" required="" value="2">
                                                    <label for="rd-radio-artist" style="font-weight:0px!important;">Nhạc sĩ<span class="start-red">*</span></label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <span for="example-url-input" class="col-sm-2 col-form-label">Địa chỉ</span>
                                            <div class="col-sm-6">
                                                <input class="form-control" type="text" value="" id="example-url-input" name="address">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <span for="example-url-input" class="col-sm-2 col-form-label">Điện thoai</span>
                                            <div class="col-sm-2">
                                        ...
                                        <div class="form-group row">
                                            <span for="example-url-input" class="col-sm-2 col-form-label">Ngày cấp</span>
                                            <div class="col-sm-3">
                                            ...
                                            <span for="example-url-input" class="col-sm-1 col-form-label">Nơi cấp</span>
                                            <div class="col-sm-2">
                                        ...
                                        <div class="form-group row">
                                            <span for="example-url-input" class="col-sm-2 col-form-label">Quốc tịch</span>
                                            <div class="col-sm-2">
                                                <input class="form-control" type="text" value="" id="example-url-input" name="nationality">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <span for="example-url-input" class="col-sm-2 col-form-label">Mã số thuế</span>
                                            <div class="col-sm-2">
                                                <input class="form-control" type="text" value="" id="example-url-input" name="tax_code">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <span for="example-url-input" class="col-sm-2 col-form-label">Tài khoản</span>
                                            <div class="col-sm-2">
                                                <input class="form-control" type="text" value="" id="example-url-input" name="bank">
                                            </div>
                                            <span for="example-url-input" class="col-sm-2 col-form-label">Tên chủ tài khoản</span>
                                            <div class="col-sm-2">
                                                <input class="form-control" type="text" value="" id="example-url-input" name="bank_holder">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <span for="example-url-input" class="col-sm-2 col-form-label">Tên ngân hàng</span>
                                            <div class="col-sm-6">
                                                <input class="form-control" type="text" value="" id="example-url-input" name="bank_name">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <span for="example-url-input" class="col-sm-2 col-form-label">Chi nhánh</span>
                                            <div class="col-sm-6">
                        ...
                        <div class="form-group row" style="display:none;">
                            <div class="col-md-7" id="modalSinger">
                                <div class="panel panel-bd">
                                    <div class="panel-heading">
                                        <div class="panel-title">
                                            <h4>Cấp tài khoản đăng nhập</h4>
                                        </div>
                                    </div>
                                    <div class="panel-body text-center">
                                        <div class="form-group row">
                                            <label class="label-top col-md-2 control-label text-right">Họ &amp; tên</label>
                                        ...
                                        <div class="form-group row text-center">
                                            <label class="label-top col-md-2 control-label text-right">Nghệ danh</label>
                                            <div class="col-md-6 text-left">
                                                <span name="nickname"></span>
                                            </div>
                                        </div>
                                        <div class="form-group row text-center">
                                            <label class="label-top col-md-2 control-label text-right">Tên đăng nhập</label>
                                        ...
                                        <div class="form-group row text-center">
                                            <label class="label-top col-md-2 control-label text-right">Mật khẩu</label>
                                            <div class="col-md-6 inputGroupContainer">
                                                <div class="input-group">
                                            ...
                                            <div class="col-md-2">
                                                <button id="random_pass" onclick="javascript:randompass();" type="button" class="btn btn-default btn-rounded w-md m-b-5">Mật khẩu random</button>
                                            </div>
                                        </div>
                                        <div class="form-group row text-center">
                                            <label class="label-top col-md-2 control-label text-right">Hình đại diện</label>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="table-responsive">
                                            <div id="tb_singer_wrapper" class="dataTables_wrapper no-footer">
                                                ...
                                                <div id="tb_singer_processing" class="dataTables_processing" style="display: none;">Đang tìm kiếm...</div>
                                                <table id="tb_song" class="display table-striped dataTable no-footer" width="100%" cellspacing="0" role="grid" aria-describedby="tb_song_info" style="width: 100%;">
                                                    <thead>
                                                        <tr class="bg-tr" role="row">
                                                            ...
                                                            <th class="dt-center sorting" tabindex="0" aria-controls="tb_singer" rowspan="1" colspan="1" style="width: 188px;" aria-label="Địa chỉ: activate to sort column ascending">Address</th>
                                                    ...
                                                    <tbody>
                                                        <tr role="row" class="odd">
                                                            ...
                                                            <td class="sorting_1"><i class="material-icons" title="Tên"></i> Phan Quốc Thắng<br><i class="material-icons" title="Nghệ danh"></i> Writter: LEO</td>
                                                            <td></td>
                                                            <td class=" dt-center"></td>
                                                            <td class=" dt-center"> <a href="javascript:;" title="Chỉnh sửa thông tin Ca sĩ, tác giả" style="color:silver;border-color:silver"><i class="fa fa-edit" aria-hidden="true"></i></a></td>
                                                        </tr>
                                                        <tr role="row" class="even">
                                                            <td class=" dt-center w-1">2</td>
                                                            <td class="sorting_1"><i class="material-icons" title="Tên"></i> Nguyễn Văn Sang<br><i class="material-icons" title="Nghệ danh"></i> Singer: Nguyễn Văn Sang</td>
                                                            <td></td>
                                                            <td class=" dt-center"></td>
                                                            <td class=" dt-center"> <a href="javascript:;" title="Chỉnh sửa thông tin Ca sĩ, tác giả" style="color:silver;border-color:silver"><i class="fa fa-edit" aria-hidden="true"></i></a></td>
                                                        </tr>
                                                        <tr role="row" class="odd">
                                                            ...
                                                            <td class="sorting_1"><i class="material-icons" title="Tên"></i> Thanh<br><i class="material-icons" title="Nghệ danh"></i> Singer: ThanhRap</td>
                                                            <td></td>
                                                            <td class=" dt-center"></td>
                                                            <td class=" dt-center"> <a href="javascript:;" title="Chỉnh sửa thông tin Ca sĩ, tác giả" style="color:silver;border-color:silver"><i class="fa fa-edit" aria-hidden="true"></i></a></td>
                                                        </tr>
                                                        <tr role="row" class="even">
                                                            ...
                                                            <td class="sorting_1"><i class="material-icons" title="Tên"></i> Nguyễn Ngọc Hiếu<br><i class="material-icons" title="Nghệ danh"></i> Singer: Hardi</td>
                                                            <td></td>
                                                            <td class=" dt-center"></td>
                                                            <td class=" dt-center"> <a href="javascript:;" title="Chỉnh sửa thông tin Ca sĩ, tác giả" style="color:silver;border-color:silver"><i class="fa fa-edit" aria-hidden="true"></i></a></td>
                                                        </tr>
                                                        <tr role="row" class="odd">
                                                            ...
                                                            <td class="sorting_1"><i class="material-icons" title="Tên"></i> Đinh Gia Khánh<br><i class="material-icons" title="Nghệ danh"></i> Singer: Kaydi</td>
                                                            <td></td>
                                                            <td class=" dt-center"></td>
                                                            <td class=" dt-center"> <a href="javascript:;" title="Chỉnh sửa thông tin Ca sĩ, tác giả" style="color:silver;border-color:silver"><i class="fa fa-edit" aria-hidden="true"></i></a></td>
                                                        </tr>
                                                        <tr role="row" class="even">
                                                            ...
                                                            <td class="sorting_1"><i class="material-icons" title="Tên"></i> Nguyễn Lân<br><i class="material-icons" title="Nghệ danh"></i> Singer: SoSick</td>
                                                            <td></td>
                                                            <td class=" dt-center"></td>
                                                            <td class=" dt-center"> <a href="javascript:;" title="Chỉnh sửa thông tin Ca sĩ, tác giả" style="color:silver;border-color:silver"><i class="fa fa-edit" aria-hidden="true"></i></a></td>
                                                        </tr>
                                                        <tr role="row" class="odd">
                                                            ...
                                                            <td class="sorting_1"><i class="material-icons" title="Tên"></i> Tcunz<br><i class="material-icons" title="Nghệ danh"></i> Singer: Tcunz</td>
                                                            <td></td>
                                                            <td class=" dt-center"></td>
                                                            <td class=" dt-center"> <a href="javascript:;" title="Chỉnh sửa thông tin Ca sĩ, tác giả" style="color:silver;border-color:silver"><i class="fa fa-edit" aria-hidden="true"></i></a></td>
                                                        </tr>
                                                        <tr role="row" class="even">
                                                            ...
                                                            <td class="sorting_1"><i class="material-icons" title="Tên"></i> Young Bi<br><i class="material-icons" title="Nghệ danh"></i> Singer: Young Bi</td>
                                                            <td></td>
                                                            <td class=" dt-center"></td>
                                                            <td class=" dt-center"> <a href="javascript:;" title="Chỉnh sửa thông tin Ca sĩ, tác giả" style="color:silver;border-color:silver"><i class="fa fa-edit" aria-hidden="true"></i></a></td>
                                                        </tr>
                                                        <tr role="row" class="odd">
                                                            ...
                                                            <td class="sorting_1"><i class="material-icons" title="Tên"></i> Yangbe<br><i class="material-icons" title="Nghệ danh"></i> Singer: Yangbe</td>
                                                            <td></td>
                                                            <td class=" dt-center"></td>
                                                            <td class=" dt-center"> <a href="javascript:;" title="Chỉnh sửa thông tin Ca sĩ, tác giả" style="color:silver;border-color:silver"><i class="fa fa-edit" aria-hidden="true"></i></a></td>
                                                        </tr>
                                                        <tr role="row" class="even">
                                                            ...
                                                            <td class="sorting_1"><i class="material-icons" title="Tên"></i> Trần Quang Tuấn Tú<br><i class="material-icons" title="Nghệ danh"></i> Singer: Trần Quang Tuấn Tú</td>
                                                            <td></td>
                                                            <td class=" dt-center"></td>
                                                            <td class=" dt-center"> <a href="javascript:;" title="Chỉnh sửa thông tin Ca sĩ, tác giả" style="color:silver;border-color:silver"><i class="fa fa-edit" aria-hidden="true"></i></a></td>
                                                        </tr>
                                                        <tr role="row" class="odd">
                                                            ...
                                                            <td class="sorting_1"><i class="material-icons" title="Tên"></i> Ngọc Khoa<br><i class="material-icons" title="Nghệ danh"></i> Singer: Ngọc Khoa</td>
                                                            <td></td>
                                                            <td class=" dt-center"></td>
                                                            <td class=" dt-center"> <a href="javascript:;" title="Chỉnh sửa thông tin Ca sĩ, tác giả" style="color:silver;border-color:silver"><i class="fa fa-edit" aria-hidden="true"></i></a></td>
                                                        </tr>
                                                        <tr role="row" class="even">
                                                            ...
                                                            <td class="sorting_1"><i class="material-icons" title="Tên"></i> Jayk<br><i class="material-icons" title="Nghệ danh"></i> Singer: Jayk</td>
                                                            <td></td>
                                                            <td class=" dt-center"></td>
                                                            <td class=" dt-center"> <a href="javascript:;" title="Chỉnh sửa thông tin Ca sĩ, tác giả" style="color:silver;border-color:silver"><i class="fa fa-edit" aria-hidden="true"></i></a></td>
                                                        </tr>
                                                        <tr role="row" class="odd">
                                                            ...
                                                            <td class="sorting_1"><i class="material-icons" title="Tên"></i> Tiennekk<br><i class="material-icons" title="Nghệ danh"></i> Singer: Tiennekk</td>
                                                            <td></td>
                                                            <td class=" dt-center"></td>
                                                            <td class=" dt-center"> <a href="javascript:;" title="Chỉnh sửa thông tin Ca sĩ, tác giả" style="color:silver;border-color:silver"><i class="fa fa-edit" aria-hidden="true"></i></a></td>
                                                        </tr>
                                                        <tr role="row" class="even">
                                                            ...
                                                            <td class="sorting_1"><i class="material-icons" title="Tên"></i> Rút Kinh Nghiệm<br><i class="material-icons" title="Nghệ danh"></i> Singer: Rút Kinh Nghiệm</td>
                                                            <td></td>
                                                            <td class=" dt-center"></td>
                                                            <td class=" dt-center"> <a href="javascript:;" title="Chỉnh sửa thông tin Ca sĩ, tác giả" style="color:silver;border-color:silver"><i class="fa fa-edit" aria-hidden="true"></i></a></td>
                                                        </tr>
                                                        <tr role="row" class="odd">
                                                            ...
                                                            <td class="sorting_1"><i class="material-icons" title="Tên"></i> ĐỆ<br><i class="material-icons" title="Nghệ danh"></i> Singer: THÁI THIÊN ĐỆ</td>
                                                            <td></td>
                                                            <td class=" dt-center"></td>
                                                            <td class=" dt-center"> <a href="javascript:;" title="Chỉnh sửa thông tin Ca sĩ, tác giả" style="color:silver;border-color:silver"><i class="fa fa-edit" aria-hidden="true"></i></a></td>
                                                        </tr>
                                                        <tr role="row" class="even">
                                                            ...
                                                            <td class="sorting_1"><i class="material-icons" title="Tên"></i> Trần Xuân Tuấn<br><i class="material-icons" title="Nghệ danh"></i> Singer: Hổ.</td>
                                                            <td></td>
                                                            <td class=" dt-center"></td>
                                                            <td class=" dt-center"> <a href="javascript:;" title="Chỉnh sửa thông tin Ca sĩ, tác giả" style="color:silver;border-color:silver"><i class="fa fa-edit" aria-hidden="true"></i></a></td>
                                                        </tr>
                                                        <tr role="row" class="odd">
                                                            ...
                                                            <td class="sorting_1"><i class="material-icons" title="Tên"></i> Doãn Thị Nhật Hà<br><i class="material-icons" title="Nghệ danh"></i> Writter: Nhật Hà.</td>
                                                            <td></td>
                                                            <td class=" dt-center"></td>
                                                            <td class=" dt-center"> <a href="javascript:;" title="Chỉnh sửa thông tin Ca sĩ, tác giả" style="color:silver;border-color:silver"><i class="fa fa-edit" aria-hidden="true"></i></a></td>
                                                        </tr>
                                                        <tr role="row" class="even">
                                                            ...
                                                            <td class="sorting_1"><i class="material-icons" title="Tên"></i> Trần Ngọc Trung<br><i class="material-icons" title="Nghệ danh"></i> Singer: Willy</td>
                                                            <td></td>
                                                            <td class=" dt-center"></td>
                                                            <td class=" dt-center"> <a href="javascript:;" title="Chỉnh sửa thông tin Ca sĩ, tác giả" style="color:silver;border-color:silver"><i class="fa fa-edit" aria-hidden="true"></i></a></td>
                                                        </tr>
                                                        <tr role="row" class="odd">
                                                            ...
                                                            <td class="sorting_1"><i class="material-icons" title="Tên"></i> Đặng Thanh Thảo<br><i class="material-icons" title="Nghệ danh"></i> Singer: Iri</td>
                                                            <td></td>
                                                            <td class=" dt-center"></td>
                                                            <td class=" dt-center"> <a href="javascript:;" title="Chỉnh sửa thông tin Ca sĩ, tác giả" style="color:silver;border-color:silver"><i class="fa fa-edit" aria-hidden="true"></i></a></td>
                                                        </tr>
                                                        <tr role="row" class="even">
                                                            ...
                                                            <td class="sorting_1"><i class="material-icons" title="Tên"></i> Antoneus Long Mộng Gà<br><i class="material-icons" title="Nghệ danh"></i> Singer: Antoneus Long Mộng Gà</td>
                                                            <td></td>
                                                            <td class=" dt-center"></td>
                                                            <td class=" dt-center"> <a href="javascript:;" title="Chỉnh sửa thông tin Ca sĩ, tác giả" style="color:silver;border-color:silver"><i class="fa fa-edit" aria-hidden="true"></i></a></td>
                                                        </tr>
